...
ggplot(data.frame(x=as.vector(groups)), aes(x=x)) + geom_histogram() + xlab("Cells per pseudobulk cluster") + ggtitle("Nummber of cells by grouping (Treatment, Cluster, Replicate, Cell line)")

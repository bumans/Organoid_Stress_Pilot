...
```{r}
organoid.combined.sct01 <- FindClusters(organoid.combined.sct, resolution=0.1)
...
voomed0 <- voomWithDreamWeights(d0, fbase, pseudo0$meta, plot=TRUE)
...
fbase <- ~  (1|cell.line) + (1|stim) + (1|replicate)
voomed2 <- voomWithDreamWeights(d2, fbase, pseudo2$meta, plot=TRUE)
...
fbase <- ~  (1|cell.line) + (1|stim) + (1|replicate)
voomed3 <- voomWithDreamWeights(d3, fbase, pseudo3$meta, plot=TRUE)
...
fbase <- ~  (1|cell.line) + (1|stim) + (1|replicate)
voomed4 <- voomWithDreamWeights(d4, fbase, pseudo4$meta, plot=TRUE)
...
fbase <- ~  (1|cell.line) + (1|stim) + (1|replicate)
voomed5 <- voomWithDreamWeights(d5, fbase, pseudo5$meta, plot=TRUE)
...
fbase <- ~  (1|cell.line) + (1|stim) + (1|replicate)
voomed6 <- voomWithDreamWeights(d6, fbase, pseudo6$meta, plot=TRUE)
...
fbase <- ~  (1|cell.line) + (1|stim) + (1|replicate)
voomed7 <- voomWithDreamWeights(d7, fbase, pseudo7$meta, plot=TRUE)
...
fbase <- ~  (1|cell.line) + (1|stim) + (1|replicate)
voomed8 <- voomWithDreamWeights(d8, fbase, pseudo8$meta, plot=TRUE)
...
d0.5000 <- d0.5000[keep,]
fbase <- ~  (1|cell.line) + (1|stim) + (1|replicate)
voomed0.5000 <- voomWithDreamWeights(d0.5000, fbase, pseudo0.5000$meta, plot=TRUE)
...
d0.2000 <- d0.2000[keep,]
fbase <- ~  (1|cell.line) + (1|stim) + (1|replicate)
voomed0.2000 <- voomWithDreamWeights(d0.2000, fbase, pseudo0.2000$meta, plot=TRUE)
...
d0.500 <- d0.500[keep,]
fbase <- ~  (1|cell.line) + (1|stim) + (1|replicate)
voomed0.500 <- voomWithDreamWeights(d0.500, fbase, pseudo0.500$meta, plot=TRUE)
...
d1.5000 <- d1.5000[keep,]
fbase <- ~  (1|cell.line) + (1|stim) + (1|replicate)
voomed1.5000 <- voomWithDreamWeights(d1.5000, fbase, pseudo1.5000$meta, plot=TRUE)
...
d1.2000 <- d1.2000[keep,]
fbase <- ~  (1|cell.line) + (1|stim) + (1|replicate)
voomed1.2000 <- voomWithDreamWeights(d1.2000, fbase, pseudo1.2000$meta, plot=TRUE)
...
d1.500 <- d1.500[keep,]
fbase <- ~  (1|cell.line) + (1|stim) + (1|replicate)
voomed1.500 <- voomWithDreamWeights(d1.500, fbase, pseudo1.500$meta, plot=TRUE)
...
d2.5000 <- d2.5000[keep,]
fbase <- ~  (1|cell.line) + (1|stim) + (1|replicate)
voomed2.5000 <- voomWithDreamWeights(d2.5000, fbase, pseudo2.5000$meta, plot=TRUE)
...
d2.2000 <- d2.2000[keep,]
fbase <- ~  (1|cell.line) + (1|stim) + (1|replicate)
voomed2.2000 <- voomWithDreamWeights(d2.2000, fbase, pseudo2.2000$meta, plot=TRUE)
...
d2.500 <- d2.500[keep,]
fbase <- ~  (1|cell.line) + (1|stim) + (1|replicate)
voomed2.500 <- voomWithDreamWeights(d2.500, fbase, pseudo2.500$meta, plot=TRUE)
...
fbase <- ~  (1|cell.line) + (1|stim) + (1|replicate)
voomed_all <- voomWithDreamWeights(d_all, fbase, pseudo_all$meta, plot=TRUE)
...
plotVarPart(vp_all) + ggtitle("Variance partition cluster _all (resolution=0.1)")
```
...
###Adding fixed effect metadata to variance partition

```{r cluster1-readdepth}
faugmented <- ~  ncounts + (1|cell.line) + (1|stim) + (1|replicate)
voomed1aug <- voomWithDreamWeights(d1, faugmented, pseudo1$meta, plot=TRUE)
...
```
Here, the `ncounts` effect is just the total size of the pseudobulk matrix (as in, sum of all elements) for each partition, divided by the largest sum.  This is...maybe not quite right, but it's a start.

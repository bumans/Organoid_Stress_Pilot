...
From these datasets, I attempted 3 forms of analysis.  First, [differential expression](de_full.html), going cluster by cluster.  Second, [variance decomposition](variance_full.html), using what is essentially an ANOVA framework implemented in the `variancePartition` package.  Third, [PCA](pca_full.html) to compare overall variation with known parameters of the experiment and samples.
